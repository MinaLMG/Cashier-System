                        ...
                        >
                            <thead>
                                <tr>
                                    ...
                                    <th className={tableclasses.head}>الخصم</th>
                                    <th className={tableclasses.head}>
                                        الصافي
                                    </th>
                                    <th className={tableclasses.head}>
                                    ...
                                    <th className={tableclasses.head}>الربح</th>
                                </tr>
                            </thead>
                            <tbody>
                                {invoices.length === 0 ? (
